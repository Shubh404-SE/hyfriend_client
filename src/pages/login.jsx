  ...
  return (
    <div className="bg-conversation-panel-background h-[100vh] w-full flex items-center justify-center">
      <div className="flex items-center flex-col p-2 m-2 w-fit border-white border-2 shadow-md shadow-teal-light rounded-md">
        ...
        <button
          className=" group flex justify-center items-center gap-1 text-c3 mt-5 cursor-pointer"
          onClick={signinWithGoogle}
        >
          <FcGoogle className="text-6xl" />
          <span className=" text-md font-extrabold text-xl text-teal-light group-hover:text-white duration-300 transition-all">
            Sign-in With Google
          </span>
        </button>
      </div>
